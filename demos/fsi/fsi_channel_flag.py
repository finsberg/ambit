...
def main():
    ...
    """
    FEM_PARAMS_SOLID = {"order_disp": 2, "order_pres": 1, "quad_degree": 5, "incompressible_2field": False}
    ...
    MATERIALS_SOLID = {
        "MAT1": {"stvenantkirchhoff": {"Emod": 2.0 * mu_s * (1.0 + nu_s), "nu": nu_s}, "inertia": {"rho0": rho0_s}}
    }
    ...
    BC_DICT_FLUID = {
        "dirichlet": [{"id": [4], "dir": "all", "expression": expression1}, {"id": [2, 3], "dir": "all", "val": 0.0}]
    }
