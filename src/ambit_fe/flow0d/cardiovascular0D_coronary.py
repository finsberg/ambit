...
class coronary_circ_ZCRp_CRd:
    def __init__(self, params, varmap, auxmap, vs):
        ...
        self.V_corp_sys_u = params.get("V_corp_sys_u", 0.0)
        self.V_cord_sys_u = params.get("V_cord_sys_u", 0.0)
...
class coronary_circ_ZCRp_CRd_lr:
    def __init__(self, params, varmap, auxmap, vs):
        ...
        self.V_corp_sys_l_u = params.get("V_corp_sys_l_u", 0.0)
        self.V_cord_sys_l_u = params.get("V_cord_sys_l_u", 0.0)
        self.V_corp_sys_r_u = params.get("V_corp_sys_r_u", 0.0)
        self.V_cord_sys_r_u = params.get("V_cord_sys_r_u", 0.0)
