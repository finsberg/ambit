...
class cardiovascular0Dsyspulcaprespir(cardiovascular0Dsyspulcap):
    def __init__(
        ...
        cq,
        vq,
        valvelaws={"av": ["pwlin_pres", 0], "mv": ["pwlin_pres", 0], "pv": ["pwlin_pres", 0], "tv": ["pwlin_pres", 0]},
        cormodel=None,
        vadmodel=None,
        init=True,
        ode_par=False,
    ...
    def equation_map(self):
        ...
        fCO2_insp_ = sp.Piecewise(
            (
                (fCO2_alv_ * self.V_lung_dead + self.fCO2_ext * (self.V_lung_tidal - self.V_lung_dead))
                / self.V_lung_tidal,
                self.V_lung_tidal >= self.V_lung_dead,
            ),
            (fCO2_alv_, self.V_lung_tidal < self.V_lung_dead),
        )
        fO2_insp_ = sp.Piecewise(
            (
                (fO2_alv_ * self.V_lung_dead + self.fO2_ext * (self.V_lung_tidal - self.V_lung_dead))
                / self.V_lung_tidal,
                self.V_lung_tidal >= self.V_lung_dead,
            ),
            (fO2_alv_, self.V_lung_tidal < self.V_lung_dead),
        )
        ...
        self.f_[38] = -(1.0 / V_alv_) * (
            self.U_m
            * (
                (self.U_m - p_alv_) / self.R_airw
                + self.V_m_gas * self.kappa_CO2 * (ppCO2_cap_pul_ - fCO2_alv_ * (p_alv_ - self.p_vap_water_37))
                + self.V_m_gas * self.kappa_O2 * (ppO2_cap_pul_ - fO2_alv_ * (p_alv_ - self.p_vap_water_37))
            )
            - p_alv_ * q_alv_
        )

        self.f_[39] = -(1.0 / V_alv_) * (
            self.V_m_gas * self.kappa_CO2 * (ppCO2_cap_pul_ - fCO2_alv_ * p_alv_)
            + (fCO2_insp_ - fCO2_alv_) * q_insp_
            - fCO2_alv_
            * (
                self.V_m_gas * self.kappa_O2 * (ppO2_cap_pul_ - fO2_alv_ * (p_alv_ - self.p_vap_water_37))
                + self.V_m_gas * self.kappa_CO2 * (ppCO2_cap_pul_ - fCO2_alv_ * (p_alv_ - self.p_vap_water_37))
        ...
        self.f_[40] = -(1.0 / V_alv_) * (
            self.V_m_gas * self.kappa_O2 * (ppO2_cap_pul_ - fO2_alv_ * p_alv_)
            + (fO2_insp_ - fO2_alv_) * q_insp_
            - fO2_alv_
            * (
                self.V_m_gas * self.kappa_CO2 * (ppCO2_cap_pul_ - fCO2_alv_ * (p_alv_ - self.p_vap_water_37))
                + self.V_m_gas * self.kappa_O2 * (ppO2_cap_pul_ - fO2_alv_ * (p_alv_ - self.p_vap_water_37))
        ...
        self.f_[46] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_at_r_, ppO2_at_r_) * self.dcbO2_dppO2(ppCO2_at_r_, ppO2_at_r_)
                    - self.dcbO2_dppCO2(ppCO2_at_r_, ppO2_at_r_) * self.dcbCO2_dppO2(ppCO2_at_r_, ppO2_at_r_)
                ),
                -1.0,
            )
            * (
                self.dcbO2_dppO2(ppCO2_at_r_, ppO2_at_r_)
                * (q_ven_sys_ * (self.cbCO2(ppCO2_at_r_, ppO2_at_r_) - self.cbCO2(ppCO2_ven_sys_, ppO2_ven_sys_)))
                - self.dcbCO2_dppO2(ppCO2_at_r_, ppO2_at_r_)
                * (q_ven_sys_ * (self.cbO2(ppCO2_at_r_, ppO2_at_r_) - self.cbO2(ppCO2_ven_sys_, ppO2_ven_sys_)))
            )
        )
        # right atrium O2
        self.f_[47] = (
            ...
            * (
                self.dcbCO2_dppCO2(ppCO2_at_r_, ppO2_at_r_)
                * (q_ven_sys_ * (self.cbO2(ppCO2_at_r_, ppO2_at_r_) - self.cbO2(ppCO2_ven_sys_, ppO2_ven_sys_)))
                - self.dcbO2_dppCO2(ppCO2_at_r_, ppO2_at_r_)
                * (q_ven_sys_ * (self.cbCO2(ppCO2_at_r_, ppO2_at_r_) - self.cbCO2(ppCO2_ven_sys_, ppO2_ven_sys_)))
            )
        )
        ...
        self.f_[48] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_v_r_, ppO2_v_r_) * self.dcbO2_dppO2(ppCO2_v_r_, ppO2_v_r_)
                    - self.dcbO2_dppCO2(ppCO2_v_r_, ppO2_v_r_) * self.dcbCO2_dppO2(ppCO2_v_r_, ppO2_v_r_)
                ),
                -1.0,
            )
            * (
                self.dcbO2_dppO2(ppCO2_v_r_, ppO2_v_r_)
                * (q_vin_r_ * (self.cbCO2(ppCO2_v_r_, ppO2_v_r_) - self.cbCO2(ppCO2_at_r_, ppO2_at_r_)))
                - self.dcbCO2_dppO2(ppCO2_v_r_, ppO2_v_r_)
                * (q_vin_r_ * (self.cbO2(ppCO2_v_r_, ppO2_v_r_) - self.cbO2(ppCO2_at_r_, ppO2_at_r_)))
            )
        )
        # right ventricle O2
        self.f_[49] = (
            ...
            * (
                self.dcbCO2_dppCO2(ppCO2_v_r_, ppO2_v_r_)
                * (q_vin_r_ * (self.cbO2(ppCO2_v_r_, ppO2_v_r_) - self.cbO2(ppCO2_at_r_, ppO2_at_r_)))
                - self.dcbO2_dppCO2(ppCO2_v_r_, ppO2_v_r_)
                * (q_vin_r_ * (self.cbCO2(ppCO2_v_r_, ppO2_v_r_) - self.cbCO2(ppCO2_at_r_, ppO2_at_r_)))
            )
        )
        ...
        self.f_[50] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_ar_pul_, ppO2_ar_pul_) * self.dcbO2_dppO2(ppCO2_ar_pul_, ppO2_ar_pul_)
                    - self.dcbO2_dppCO2(ppCO2_ar_pul_, ppO2_ar_pul_) * self.dcbCO2_dppO2(ppCO2_ar_pul_, ppO2_ar_pul_)
                ),
                -1.0,
            )
            * (
                self.dcbO2_dppO2(ppCO2_ar_pul_, ppO2_ar_pul_)
                * (q_vout_r_ * (self.cbCO2(ppCO2_ar_pul_, ppO2_ar_pul_) - self.cbCO2(ppCO2_v_r_, ppO2_v_r_)))
                - self.dcbCO2_dppO2(ppCO2_ar_pul_, ppO2_ar_pul_)
                * (q_vout_r_ * (self.cbO2(ppCO2_ar_pul_, ppO2_ar_pul_) - self.cbO2(ppCO2_v_r_, ppO2_v_r_)))
            )
        )
        ...
        self.f_[51] = (
            ...
            * (
                self.dcbCO2_dppCO2(ppCO2_ar_pul_, ppO2_ar_pul_)
                * (q_vout_r_ * (self.cbO2(ppCO2_ar_pul_, ppO2_ar_pul_) - self.cbO2(ppCO2_v_r_, ppO2_v_r_)))
                - self.dcbO2_dppCO2(ppCO2_ar_pul_, ppO2_ar_pul_)
                * (q_vout_r_ * (self.cbCO2(ppCO2_ar_pul_, ppO2_ar_pul_) - self.cbCO2(ppCO2_v_r_, ppO2_v_r_)))
            )
        )
        ...
        self.f_[52] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_cap_pul_, ppO2_cap_pul_) * self.dcbO2_dppO2(ppCO2_cap_pul_, ppO2_cap_pul_)
                    - self.dcbO2_dppCO2(ppCO2_cap_pul_, ppO2_cap_pul_)
                    * self.dcbCO2_dppO2(ppCO2_cap_pul_, ppO2_cap_pul_)
                ),
                -1.0,
            )
            * (
                self.dcbO2_dppO2(ppCO2_cap_pul_, ppO2_cap_pul_)
                * (
                    q_ar_pul_ * (self.cbCO2(ppCO2_cap_pul_, ppO2_cap_pul_) - self.cbCO2(ppCO2_ar_pul_, ppO2_ar_pul_))
                    + self.kappa_CO2 * (ppCO2_cap_pul_ - fCO2_alv_ * (p_alv_ - self.p_vap_water_37))
                )
                - self.dcbCO2_dppO2(ppCO2_cap_pul_, ppO2_cap_pul_)
                * (
                    q_ar_pul_ * (self.cbO2(ppCO2_cap_pul_, ppO2_cap_pul_) - self.cbO2(ppCO2_ar_pul_, ppO2_ar_pul_))
                    + self.kappa_O2 * (ppO2_cap_pul_ - fO2_alv_ * (p_alv_ - self.p_vap_water_37))
                )
            )
        )
        ...
        self.f_[53] = (
            ...
            * (
                self.dcbCO2_dppCO2(ppCO2_cap_pul_, ppO2_cap_pul_)
                * (
                    q_ar_pul_ * (self.cbO2(ppCO2_cap_pul_, ppO2_cap_pul_) - self.cbO2(ppCO2_ar_pul_, ppO2_ar_pul_))
                    + self.kappa_O2 * (ppO2_cap_pul_ - fO2_alv_ * (p_alv_ - self.p_vap_water_37))
                )
        ...
        self.f_[54] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_ven_pul_, ppO2_ven_pul_) * self.dcbO2_dppO2(ppCO2_ven_pul_, ppO2_ven_pul_)
                    - self.dcbO2_dppCO2(ppCO2_ven_pul_, ppO2_ven_pul_)
                    * self.dcbCO2_dppO2(ppCO2_ven_pul_, ppO2_ven_pul_)
                ),
                -1.0,
            )
            * (
                self.dcbO2_dppO2(ppCO2_ven_pul_, ppO2_ven_pul_)
                * (q_cap_pul_ * (self.cbCO2(ppCO2_ven_pul_, ppO2_ven_pul_) - self.cbCO2(ppCO2_cap_pul_, ppO2_cap_pul_)))
                - self.dcbCO2_dppO2(ppCO2_ven_pul_, ppO2_ven_pul_)
                * (q_cap_pul_ * (self.cbO2(ppCO2_ven_pul_, ppO2_ven_pul_) - self.cbO2(ppCO2_cap_pul_, ppO2_cap_pul_)))
            )
        )
        # pulmonary veins O2
        self.f_[55] = (
            ...
            * (
                self.dcbCO2_dppCO2(ppCO2_ven_pul_, ppO2_ven_pul_)
                * (q_cap_pul_ * (self.cbO2(ppCO2_ven_pul_, ppO2_ven_pul_) - self.cbO2(ppCO2_cap_pul_, ppO2_cap_pul_)))
                - self.dcbO2_dppCO2(ppCO2_ven_pul_, ppO2_ven_pul_)
                * (q_cap_pul_ * (self.cbCO2(ppCO2_ven_pul_, ppO2_ven_pul_) - self.cbCO2(ppCO2_cap_pul_, ppO2_cap_pul_)))
            )
        ...
        self.f_[56] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_at_l_, ppO2_at_l_) * self.dcbO2_dppO2(ppCO2_at_l_, ppO2_at_l_)
                    - self.dcbO2_dppCO2(ppCO2_at_l_, ppO2_at_l_) * self.dcbCO2_dppO2(ppCO2_at_l_, ppO2_at_l_)
                ),
                -1.0,
            )
            * (
                self.dcbO2_dppO2(ppCO2_at_l_, ppO2_at_l_)
                * (q_ven_pul_ * (self.cbCO2(ppCO2_at_l_, ppO2_at_l_) - self.cbCO2(ppCO2_ven_pul_, ppO2_ven_pul_)))
                - self.dcbCO2_dppO2(ppCO2_at_l_, ppO2_at_l_)
                * (q_ven_pul_ * (self.cbO2(ppCO2_at_l_, ppO2_at_l_) - self.cbO2(ppCO2_ven_pul_, ppO2_ven_pul_)))
            )
        )
        # left atrium O2
        self.f_[57] = (
            ...
            * (
                self.dcbCO2_dppCO2(ppCO2_at_l_, ppO2_at_l_)
                * (q_ven_pul_ * (self.cbO2(ppCO2_at_l_, ppO2_at_l_) - self.cbO2(ppCO2_ven_pul_, ppO2_ven_pul_)))
                - self.dcbO2_dppCO2(ppCO2_at_l_, ppO2_at_l_)
                * (q_ven_pul_ * (self.cbCO2(ppCO2_at_l_, ppO2_at_l_) - self.cbCO2(ppCO2_ven_pul_, ppO2_ven_pul_)))
            )
        )
        ...
        self.f_[58] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_v_l_, ppO2_v_l_) * self.dcbO2_dppO2(ppCO2_v_l_, ppO2_v_l_)
                    - self.dcbO2_dppCO2(ppCO2_v_l_, ppO2_v_l_) * self.dcbCO2_dppO2(ppCO2_v_l_, ppO2_v_l_)
                ),
                -1.0,
            )
            * (
                self.dcbO2_dppO2(ppCO2_v_l_, ppO2_v_l_)
                * (q_vin_l_ * (self.cbCO2(ppCO2_v_l_, ppO2_v_l_) - self.cbCO2(ppCO2_at_l_, ppO2_at_l_)))
                - self.dcbCO2_dppO2(ppCO2_v_l_, ppO2_v_l_)
                * (q_vin_l_ * (self.cbO2(ppCO2_v_l_, ppO2_v_l_) - self.cbO2(ppCO2_at_l_, ppO2_at_l_)))
            )
        )
        # left ventricle O2
        self.f_[59] = (
            ...
            * (
                self.dcbCO2_dppCO2(ppCO2_v_l_, ppO2_v_l_)
                * (q_vin_l_ * (self.cbO2(ppCO2_v_l_, ppO2_v_l_) - self.cbO2(ppCO2_at_l_, ppO2_at_l_)))
                - self.dcbO2_dppCO2(ppCO2_v_l_, ppO2_v_l_)
                * (q_vin_l_ * (self.cbCO2(ppCO2_v_l_, ppO2_v_l_) - self.cbCO2(ppCO2_at_l_, ppO2_at_l_)))
            )
        )
        ...
        self.f_[60] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_ar_sys_, ppO2_ar_sys_) * self.dcbO2_dppO2(ppCO2_ar_sys_, ppO2_ar_sys_)
                    - self.dcbO2_dppCO2(ppCO2_ar_sys_, ppO2_ar_sys_) * self.dcbCO2_dppO2(ppCO2_ar_sys_, ppO2_ar_sys_)
                ),
                -1.0,
            )
            * (
                self.dcbO2_dppO2(ppCO2_ar_sys_, ppO2_ar_sys_)
                * (q_vout_l_ * (self.cbCO2(ppCO2_ar_sys_, ppO2_ar_sys_) - self.cbCO2(ppCO2_v_l_, ppO2_v_l_)))
                - self.dcbCO2_dppO2(ppCO2_ar_sys_, ppO2_ar_sys_)
                * (q_vout_l_ * (self.cbO2(ppCO2_ar_sys_, ppO2_ar_sys_) - self.cbO2(ppCO2_v_l_, ppO2_v_l_)))
            )
        )
        ...
        self.f_[61] = (
            ...
            * (
                self.dcbCO2_dppCO2(ppCO2_ar_sys_, ppO2_ar_sys_)
                * (q_vout_l_ * (self.cbO2(ppCO2_ar_sys_, ppO2_ar_sys_) - self.cbO2(ppCO2_v_l_, ppO2_v_l_)))
                - self.dcbO2_dppCO2(ppCO2_ar_sys_, ppO2_ar_sys_)
                * (q_vout_l_ * (self.cbCO2(ppCO2_ar_sys_, ppO2_ar_sys_) - self.cbCO2(ppCO2_v_l_, ppO2_v_l_)))
            )
        )
        ...
        self.f_[62] = (
            ...
            * sp.Pow(
                (
                    (
                        self.dcbCO2_dppCO2(ppCO2_arspl_sys_, ppO2_arspl_sys_)
                        + (self.V_tissspl / V_arspl_sys_) * self.dctCO2_dppCO2(ppCO2_arspl_sys_)
                    )
                    * (
                        self.dcbO2_dppO2(ppCO2_arspl_sys_, ppO2_arspl_sys_)
                        + (self.V_tissspl / V_arspl_sys_) * self.dctO2_dppO2(ppO2_arspl_sys_)
                    )
                    - self.dcbO2_dppCO2(ppCO2_arspl_sys_, ppO2_arspl_sys_)
            ...
            * (
                ...
                * (
                    q_arspl_sys_in_
                    * (self.cbCO2(ppCO2_arspl_sys_, ppO2_arspl_sys_) - self.cbCO2(ppCO2_ar_sys_, ppO2_ar_sys_))
                    - self.M_CO2_arspl
                )
                - self.dcbCO2_dppO2(ppCO2_arspl_sys_, ppO2_arspl_sys_)
                * (
                    q_arspl_sys_in_
                    * (self.cbO2(ppCO2_arspl_sys_, ppO2_arspl_sys_) - self.cbO2(ppCO2_ar_sys_, ppO2_ar_sys_))
                    + self.M_O2_arspl * self.ctO2(ppO2_arspl_sys_) / (self.beta_O2 + self.ctO2(ppO2_arspl_sys_))
                )
            )
        )
        ...
        self.f_[64] = (
            ...
            * sp.Pow(
                (
                    (
                        self.dcbCO2_dppCO2(ppCO2_arespl_sys_, ppO2_arespl_sys_)
                        + (self.V_tissespl / V_arespl_sys_) * self.dctCO2_dppCO2(ppCO2_arespl_sys_)
                    )
                    * (
                        self.dcbO2_dppO2(ppCO2_arespl_sys_, ppO2_arespl_sys_)
                        + (self.V_tissespl / V_arespl_sys_) * self.dctO2_dppO2(ppO2_arespl_sys_)
                    )
                    - self.dcbO2_dppCO2(ppCO2_arespl_sys_, ppO2_arespl_sys_)
                    * self.dcbCO2_dppO2(ppCO2_arespl_sys_, ppO2_arespl_sys_)
                ),
                -1.0,
            )
            * (
                ...
                * (
                    q_arespl_sys_in_
                    * (self.cbCO2(ppCO2_arespl_sys_, ppO2_arespl_sys_) - self.cbCO2(ppCO2_ar_sys_, ppO2_ar_sys_))
                    - self.M_CO2_arespl
                )
                - self.dcbCO2_dppO2(ppCO2_arespl_sys_, ppO2_arespl_sys_)
                * (
                    q_arespl_sys_in_
                    * (self.cbO2(ppCO2_arespl_sys_, ppO2_arespl_sys_) - self.cbO2(ppCO2_ar_sys_, ppO2_ar_sys_))
                    + self.M_O2_arespl * self.ctO2(ppO2_arespl_sys_) / (self.beta_O2 + self.ctO2(ppO2_arespl_sys_))
                )
            )
        )
        ...
        self.f_[66] = (
            ...
            * sp.Pow(
                (
                    (
                        self.dcbCO2_dppCO2(ppCO2_armsc_sys_, ppO2_armsc_sys_)
                        + (self.V_tissmsc / V_armsc_sys_) * self.dctCO2_dppCO2(ppCO2_armsc_sys_)
                    )
                    * (
                        self.dcbO2_dppO2(ppCO2_armsc_sys_, ppO2_armsc_sys_)
                        + (self.V_tissmsc / V_armsc_sys_) * self.dctO2_dppO2(ppO2_armsc_sys_)
                    )
                    - self.dcbO2_dppCO2(ppCO2_armsc_sys_, ppO2_armsc_sys_)
                    * self.dcbCO2_dppO2(ppCO2_armsc_sys_, ppO2_armsc_sys_)
                ),
                -1.0,
            )
            * (
                ...
                * (
                    q_armsc_sys_in_
                    * (self.cbCO2(ppCO2_armsc_sys_, ppO2_armsc_sys_) - self.cbCO2(ppCO2_ar_sys_, ppO2_ar_sys_))
                    - self.M_CO2_armsc
                )
                - self.dcbCO2_dppO2(ppCO2_armsc_sys_, ppO2_armsc_sys_)
                * (
                    q_armsc_sys_in_
                    * (self.cbO2(ppCO2_armsc_sys_, ppO2_armsc_sys_) - self.cbO2(ppCO2_ar_sys_, ppO2_ar_sys_))
                    + self.M_O2_armsc * self.ctO2(ppO2_armsc_sys_) / (self.beta_O2 + self.ctO2(ppO2_armsc_sys_))
                )
            )
        )
        ...
        self.f_[68] = (
            ...
            * sp.Pow(
                (
                    (
                        self.dcbCO2_dppCO2(ppCO2_arcer_sys_, ppO2_arcer_sys_)
                        + (self.V_tisscer / V_arcer_sys_) * self.dctCO2_dppCO2(ppCO2_arcer_sys_)
                    )
                    * (
                        self.dcbO2_dppO2(ppCO2_arcer_sys_, ppO2_arcer_sys_)
                        + (self.V_tisscer / V_arcer_sys_) * self.dctO2_dppO2(ppO2_arcer_sys_)
                    )
                    - self.dcbO2_dppCO2(ppCO2_arcer_sys_, ppO2_arcer_sys_)
                    * self.dcbCO2_dppO2(ppCO2_arcer_sys_, ppO2_arcer_sys_)
                ),
                -1.0,
            )
            * (
                ...
                * (
                    q_arcer_sys_in_
                    * (self.cbCO2(ppCO2_arcer_sys_, ppO2_arcer_sys_) - self.cbCO2(ppCO2_ar_sys_, ppO2_ar_sys_))
                    - self.M_CO2_arcer
                )
                - self.dcbCO2_dppO2(ppCO2_arcer_sys_, ppO2_arcer_sys_)
                * (
                    q_arcer_sys_in_
                    * (self.cbO2(ppCO2_arcer_sys_, ppO2_arcer_sys_) - self.cbO2(ppCO2_ar_sys_, ppO2_ar_sys_))
                    + self.M_O2_arcer * self.ctO2(ppO2_arcer_sys_) / (self.beta_O2 + self.ctO2(ppO2_arcer_sys_))
                )
            )
        )
        ...
        self.f_[70] = (
            ...
            * sp.Pow(
                (
                    (
                        self.dcbCO2_dppCO2(ppCO2_arcor_sys_, ppO2_arcor_sys_)
                        + (self.V_tisscor / V_arcor_sys_) * self.dctCO2_dppCO2(ppCO2_arcor_sys_)
                    )
                    * (
                        self.dcbO2_dppO2(ppCO2_arcor_sys_, ppO2_arcor_sys_)
                        + (self.V_tisscor / V_arcor_sys_) * self.dctO2_dppO2(ppO2_arcor_sys_)
                    )
                    - self.dcbO2_dppCO2(ppCO2_arcor_sys_, ppO2_arcor_sys_)
                    * self.dcbCO2_dppO2(ppCO2_arcor_sys_, ppO2_arcor_sys_)
                ),
                -1.0,
            )
            * (
                ...
                * (
                    q_arcor_sys_in_
                    * (self.cbCO2(ppCO2_arcor_sys_, ppO2_arcor_sys_) - self.cbCO2(ppCO2_ar_sys_, ppO2_ar_sys_))
                    - self.M_CO2_arcor
                )
                - self.dcbCO2_dppO2(ppCO2_arcor_sys_, ppO2_arcor_sys_)
                * (
                    q_arcor_sys_in_
                    * (self.cbO2(ppCO2_arcor_sys_, ppO2_arcor_sys_) - self.cbO2(ppCO2_ar_sys_, ppO2_ar_sys_))
                    + self.M_O2_arcor * self.ctO2(ppO2_arcor_sys_) / (self.beta_O2 + self.ctO2(ppO2_arcor_sys_))
                )
            )
        )
        ...
        self.f_[72] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_venspl_sys_, ppO2_venspl_sys_)
                    * self.dcbO2_dppO2(ppCO2_venspl_sys_, ppO2_venspl_sys_)
                    - self.dcbO2_dppCO2(ppCO2_venspl_sys_, ppO2_venspl_sys_)
                    * self.dcbCO2_dppO2(ppCO2_venspl_sys_, ppO2_venspl_sys_)
                ),
                -1.0,
            )
            * (
                ...
                * (
                    q_arspl_sys_
                    * (self.cbCO2(ppCO2_venspl_sys_, ppO2_venspl_sys_) - self.cbCO2(ppCO2_arspl_sys_, ppO2_arspl_sys_))
                )
                - self.dcbCO2_dppO2(ppCO2_venspl_sys_, ppO2_venspl_sys_)
                * (
                    q_arspl_sys_
                    * (self.cbO2(ppCO2_venspl_sys_, ppO2_venspl_sys_) - self.cbO2(ppCO2_arspl_sys_, ppO2_arspl_sys_))
                )
            )
        )
        ...
        self.f_[74] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_venespl_sys_, ppO2_venespl_sys_)
                    * self.dcbO2_dppO2(ppCO2_venespl_sys_, ppO2_venespl_sys_)
                    - self.dcbO2_dppCO2(ppCO2_venespl_sys_, ppO2_venespl_sys_)
                    * self.dcbCO2_dppO2(ppCO2_venespl_sys_, ppO2_venespl_sys_)
                ),
                -1.0,
            )
            * (
                ...
                * (
                    q_arespl_sys_
                    * (
                        self.cbCO2(ppCO2_venespl_sys_, ppO2_venespl_sys_)
                        - self.cbCO2(ppCO2_arespl_sys_, ppO2_arespl_sys_)
                    )
                )
                - self.dcbCO2_dppO2(ppCO2_venespl_sys_, ppO2_venespl_sys_)
                * (
                    q_arespl_sys_
                    * (
                        self.cbO2(ppCO2_venespl_sys_, ppO2_venespl_sys_)
                        - self.cbO2(ppCO2_arespl_sys_, ppO2_arespl_sys_)
                    )
                )
            )
        )
        ...
        self.f_[76] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_venmsc_sys_, ppO2_venmsc_sys_)
                    * self.dcbO2_dppO2(ppCO2_venmsc_sys_, ppO2_venmsc_sys_)
                    - self.dcbO2_dppCO2(ppCO2_venmsc_sys_, ppO2_venmsc_sys_)
                    * self.dcbCO2_dppO2(ppCO2_venmsc_sys_, ppO2_venmsc_sys_)
                ),
                -1.0,
            )
            * (
                ...
                * (
                    q_armsc_sys_
                    * (self.cbCO2(ppCO2_venmsc_sys_, ppO2_venmsc_sys_) - self.cbCO2(ppCO2_armsc_sys_, ppO2_armsc_sys_))
                )
                - self.dcbCO2_dppO2(ppCO2_venmsc_sys_, ppO2_venmsc_sys_)
                * (
                    q_armsc_sys_
                    * (self.cbO2(ppCO2_venmsc_sys_, ppO2_venmsc_sys_) - self.cbO2(ppCO2_armsc_sys_, ppO2_armsc_sys_))
                )
            )
        )
        ...
        self.f_[78] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_vencer_sys_, ppO2_vencer_sys_)
                    * self.dcbO2_dppO2(ppCO2_vencer_sys_, ppO2_vencer_sys_)
                    - self.dcbO2_dppCO2(ppCO2_vencer_sys_, ppO2_vencer_sys_)
                    * self.dcbCO2_dppO2(ppCO2_vencer_sys_, ppO2_vencer_sys_)
                ),
                -1.0,
            )
            * (
                ...
                * (
                    q_arcer_sys_
                    * (self.cbCO2(ppCO2_vencer_sys_, ppO2_vencer_sys_) - self.cbCO2(ppCO2_arcer_sys_, ppO2_arcer_sys_))
                )
                - self.dcbCO2_dppO2(ppCO2_vencer_sys_, ppO2_vencer_sys_)
                * (
                    q_arcer_sys_
                    * (self.cbO2(ppCO2_vencer_sys_, ppO2_vencer_sys_) - self.cbO2(ppCO2_arcer_sys_, ppO2_arcer_sys_))
                )
            )
        )
        ...
        self.f_[80] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_vencor_sys_, ppO2_vencor_sys_)
                    * self.dcbO2_dppO2(ppCO2_vencor_sys_, ppO2_vencor_sys_)
                    - self.dcbO2_dppCO2(ppCO2_vencor_sys_, ppO2_vencor_sys_)
                    * self.dcbCO2_dppO2(ppCO2_vencor_sys_, ppO2_vencor_sys_)
                ),
                -1.0,
            )
            * (
                ...
                * (
                    q_arcor_sys_
                    * (self.cbCO2(ppCO2_vencor_sys_, ppO2_vencor_sys_) - self.cbCO2(ppCO2_arcor_sys_, ppO2_arcor_sys_))
                )
                - self.dcbCO2_dppO2(ppCO2_vencor_sys_, ppO2_vencor_sys_)
                * (
                    q_arcor_sys_
                    * (self.cbO2(ppCO2_vencor_sys_, ppO2_vencor_sys_) - self.cbO2(ppCO2_arcor_sys_, ppO2_arcor_sys_))
                )
            )
        )
        ...
        self.f_[82] = (
            ...
            * sp.Pow(
                (
                    self.dcbCO2_dppCO2(ppCO2_ven_sys_, ppO2_ven_sys_) * self.dcbO2_dppO2(ppCO2_ven_sys_, ppO2_ven_sys_)
                    - self.dcbO2_dppCO2(ppCO2_ven_sys_, ppO2_ven_sys_)
                    * self.dcbCO2_dppO2(ppCO2_ven_sys_, ppO2_ven_sys_)
                ),
                -1.0,
            )
            * (
                self.dcbO2_dppO2(ppCO2_ven_sys_, ppO2_ven_sys_)
                * (
                    (q_venspl_sys_ + q_venespl_sys_ + q_venmsc_sys_ + q_vencer_sys_ + q_vencor_sys_)
                    * self.cbCO2(ppCO2_ven_sys_, ppO2_ven_sys_)
                    - (
                        q_venspl_sys_ * self.cbCO2(ppCO2_venspl_sys_, ppO2_venspl_sys_)
                        + q_venespl_sys_ * self.cbCO2(ppCO2_venespl_sys_, ppO2_venespl_sys_)
                        + q_venmsc_sys_ * self.cbCO2(ppCO2_venmsc_sys_, ppO2_venmsc_sys_)
                        + q_vencer_sys_ * self.cbCO2(ppCO2_vencer_sys_, ppO2_vencer_sys_)
                        + q_vencor_sys_ * self.cbCO2(ppCO2_vencor_sys_, ppO2_vencor_sys_)
                    )
                )
                - self.dcbCO2_dppO2(ppCO2_ven_sys_, ppO2_ven_sys_)
                * (
                    (q_venspl_sys_ + q_venespl_sys_ + q_venmsc_sys_ + q_vencer_sys_ + q_vencor_sys_)
                    * self.cbO2(ppCO2_ven_sys_, ppO2_ven_sys_)
                    - (
                        q_venspl_sys_ * self.cbO2(ppCO2_venspl_sys_, ppO2_venspl_sys_)
                        + q_venespl_sys_ * self.cbO2(ppCO2_venespl_sys_, ppO2_venespl_sys_)
                        + q_venmsc_sys_ * self.cbO2(ppCO2_venmsc_sys_, ppO2_venmsc_sys_)
                        + q_vencer_sys_ * self.cbO2(ppCO2_vencer_sys_, ppO2_vencer_sys_)
                        + q_vencor_sys_ * self.cbO2(ppCO2_vencor_sys_, ppO2_vencor_sys_)
                    )
                )
            )
        )
        ...
        self.f_[83] = (
            ...
            * (
                self.dcbCO2_dppCO2(ppCO2_ven_sys_, ppO2_ven_sys_)
                * (
                    (q_venspl_sys_ + q_venespl_sys_ + q_venmsc_sys_ + q_vencer_sys_ + q_vencor_sys_)
                    * self.cbO2(ppCO2_ven_sys_, ppO2_ven_sys_)
                    - (
    ...
    def initialize(self, var, iniparam):
        ...
        if V_alv_0 >= 0:
            var[36] = V_alv_0
        if V_alv_0 < 0:
            var[36] = (self.U_m - U_t_0) / self.E_alv + self.V_lung_u
    ...
    def U_t(self):
        ...
        return (
            self.U_m
            - self.R_airw * self.omega_breath * (self.V_lung_tidal / 2.0) * sp.sin(self.omega_breath * self.t_)
            - self.E_alv * (self.V_lung_total - (self.V_lung_tidal / 2.0) * sp.cos(self.omega_breath * self.t_))
        )
    ...
    def SO2(self, ppCO2, ppO2):
        ...
        SO2_val = sp.Pow((ppO2 / ppO2_50), n) / (1.0 + sp.Pow((ppO2 / ppO2_50), n))
    ...
    def dcbO2_dppO2(self, ppCO2, ppO2):
        ...
        dcbO2_dppO2_val = self.alpha_O2 + self.c_Hb * n * sp.Pow((ppO2 / ppO2_50), n) / (
            sp.Pow((1.0 + sp.Pow((ppO2 / ppO2_50), n)), 2.0) * ppO2
        )
    ...
    def print_to_screen(self, var, aux):
        ...
        utilities.print_status(
            "{:<12s}{:<3s}{:<10.3f}{:<3s}{:<12s}{:<3s}{:<10.3f}".format(
                "SO2_ar_sys",
                " = ",
                aux[self.auxmap["SO2_ar_sys"]],
                "   ",
                "SO2_ar_pul",
                " = ",
                aux[self.auxmap["SO2_ar_pul"]],
            ),
            self.comm,
        )
        ...
        utilities.print_status(
            "{:<12s}{:<3s}{:<10.3f}{:<3s}{:<12s}{:<3s}{:<10.3f}".format(
                "ppO2_ar_sys",
                " = ",
                var_arr[self.varmap["ppO2_ar_sys"]],
                "   ",
                "ppO2_ar_pul",
                " = ",
                var_arr[self.varmap["ppO2_ar_pul"]],
            ),
            self.comm,
        )
        utilities.print_status(
            "{:<12s}{:<3s}{:<10.3f}{:<3s}{:<12s}{:<3s}{:<10.3f}".format(
                "ppCO2_ar_sys",
                " = ",
                var_arr[self.varmap["ppCO2_ar_sys"]],
                "   ",
                "ppCO2_ar_pul",
                " = ",
                var_arr[self.varmap["ppCO2_ar_pul"]],
            ),
            self.comm,
        )
