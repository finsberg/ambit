...
if category == "solid" or category == "all":
    ...
    errs["test_solid_robin_genalpha 3 restart"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_solid_robin_genalpha.py", str(8)]
    )
    ...
    errs["test_solid_robin_static_prestress 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_robin_static_prestress.py"]
    )
    errs["test_solid_robin_static_prestress 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_robin_static_prestress.py"]
    )
    ...
    errs["test_solid_growth_volstressmandel 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_growth_volstressmandel.py"]
    )
    errs["test_solid_growth_volstressmandel 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_growth_volstressmandel.py"]
    )

    errs["test_solid_growth_volstressmandel_incomp 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_growth_volstressmandel_incomp.py"]
    )
    errs["test_solid_growth_volstressmandel_incomp 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_growth_volstressmandel_incomp.py"]
    )

    errs["test_solid_growth_prescribed_iso_lv 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_growth_prescribed_iso_lv.py"]
    )
    errs["test_solid_growth_prescribed_iso_lv 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_solid_growth_prescribed_iso_lv.py"]
    )

    errs["test_solid_growthremodeling_fiberstretch 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_growthremodeling_fiberstretch.py"]
    )  # only 1 element, cannot run on multiple cores

    errs["test_solid_2dheart_frankstarling 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_solid_2dheart_frankstarling.py"]
    )
    errs["test_solid_2dheart_frankstarling 3 restart"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_solid_2dheart_frankstarling.py", str(2)]
    )
    ...
    errs["test_solid_constraint_volume_chamber 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_constraint_volume_chamber.py"]
    )
    errs["test_solid_constraint_volume_chamber 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_constraint_volume_chamber.py"]
    )
...
if category == "fluid" or category == "all":
    ...
    errs["test_fluid_p1p1_stab_cylinder_schur2x2 4"] = subprocess.call(
        ["mpiexec", "-n", "4", "python3", "test_fluid_p1p1_stab_cylinder_schur2x2.py"]
    )

    errs["test_fluid_constraint_flux_p1p1_stab_cylinder 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_fluid_constraint_flux_p1p1_stab_cylinder.py"]
    )

    errs["test_fluid_p1p1_stab_cylinder_valve 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fluid_p1p1_stab_cylinder_valve.py"]
    )
    errs["test_fluid_p1p1_stab_cylinder_valve 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_fluid_p1p1_stab_cylinder_valve.py"]
    )

if category == "fsi" or category == "all":
    errs["test_fsi_taylorhood_artseg 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fsi_taylorhood_artseg.py"]
    )
    errs["test_fsi_taylorhood_artseg 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_fsi_taylorhood_artseg.py"]
    )

    errs["test_fsi_p1p1_stab_artseg 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fsi_p1p1_stab_artseg.py"]
    )
    errs["test_fsi_p1p1_stab_artseg 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_fsi_p1p1_stab_artseg.py"]
    )
    errs["test_fsi_p1p1_stab_artseg 2 restart"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_fsi_p1p1_stab_artseg.py", str(4)]
    )

if category == "fsi_flow0d" or category == "all":
    errs["test_fsi_flow0d_p1p1_stab_artseg 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_fsi_flow0d_p1p1_stab_artseg.py"]
    )

if category == "fluid_flow0d" or category == "all":
    errs["test_fluid_flow0d_monolagr_taylorhood_cylinder 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fluid_flow0d_monolagr_taylorhood_cylinder.py"]
    )
    errs["test_fluid_flow0d_monolagr_taylorhood_cylinder 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_fluid_flow0d_monolagr_taylorhood_cylinder.py"]
    )

    errs["test_fluid_flow0d_monolagr_taylorhood_cylinder_condensed 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_fluid_flow0d_monolagr_taylorhood_cylinder_condensed.py"]
    )

if category == "fluid_ale_flow0d" or category == "all":
    errs["test_fluid_ale_flow0d_lalv_syspul_prescribed 4"] = subprocess.call(
        ["mpiexec", "-n", "4", "python3", "test_fluid_ale_flow0d_lalv_syspul_prescribed.py"]
    )

if category == "flow0d" or category == "all":
    errs["test_flow0d_0dvol_2elwindkessel_n3 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_flow0d_0dvol_2elwindkessel_n3.py"]
    )

    errs["test_flow0d_0dvol_4elwindkesselLsZ 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_flow0d_0dvol_4elwindkesselLsZ.py"]
    )
    errs["test_flow0d_0dvol_4elwindkesselLpZ 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_flow0d_0dvol_4elwindkesselLpZ.py"]
    )
    ...
    errs["test_flow0d_0dheart_syspul 1 restart"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_flow0d_0dheart_syspul.py", str(450)]
    ...
    errs["test_flow0d_0dheart_syspulcaprespir_periodic 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_flow0d_0dheart_syspulcaprespir_periodic.py"]
    )
    errs["test_flow0d_0dheart_syspulcaprespir_periodic 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_flow0d_0dheart_syspulcaprespir_periodic.py"]
    )

if category == "solid_flow0d" or category == "all":
    errs["test_solid_flow0d_monodir_4elwindkesselLsZ_chamber 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_flow0d_monodir_4elwindkesselLsZ_chamber.py"]
    )
    errs["test_solid_flow0d_monodir_4elwindkesselLsZ_chamber 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_flow0d_monodir_4elwindkesselLsZ_chamber.py"]
    )

    errs["test_solid_flow0d_monodir_4elwindkesselLsZ_chamber_bgs2x2 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_flow0d_monodir_4elwindkesselLsZ_chamber_bgs2x2.py"]
    )
    errs["test_solid_flow0d_monodir_4elwindkesselLsZ_chamber_bgs2x2fieldsplit 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_flow0d_monodir_4elwindkesselLsZ_chamber_bgs2x2fieldsplit.py"]
    )

    errs["test_solid_flow0d_monodir2field_4elwindkesselLpZ_chamber 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_flow0d_monodir2field_4elwindkesselLpZ_chamber.py"]
    )
    errs["test_solid_flow0d_monodir2field_4elwindkesselLpZ_chamber 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_flow0d_monodir2field_4elwindkesselLpZ_chamber.py"]
    )

    errs["test_solid_flow0d_monolagr2field_2elwindkessel_chamber 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_flow0d_monolagr2field_2elwindkessel_chamber.py"]
    )
    errs["test_solid_flow0d_monolagr2field_2elwindkessel_chamber 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_flow0d_monolagr2field_2elwindkessel_chamber.py"]
    )

    errs["test_solid_flow0d_monolagr_CRLinoutlink_chambers 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_flow0d_monolagr_CRLinoutlink_chambers.py"]
    )

    errs["test_solid_flow0d_monodir_syspul_2dheart_prestress 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_flow0d_monodir_syspul_2dheart_prestress.py"]
    )
    errs["test_solid_flow0d_monodir_syspul_2dheart_prestress 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_solid_flow0d_monodir_syspul_2dheart_prestress.py"]
    )
    errs["test_solid_flow0d_monodir_syspul_2dheart_prestress 3 restart"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_solid_flow0d_monodir_syspul_2dheart_prestress.py", str(3)]
    )  # tests restart from step 3

    errs["test_solid_flow0d_monodir_flux_syspulcap_3Dheart_schur2x2 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_solid_flow0d_monodir_flux_syspulcap_3Dheart_schur2x2.py"]
    )

    errs["test_solid_flow0d_monodir2field_flux_syspulcap_3Dheart_schur3x3 4"] = subprocess.call(
        ["mpiexec", "-n", "4", "python3", "test_solid_flow0d_monodir2field_flux_syspulcap_3Dheart_schur3x3.py"]
    )

    errs["test_solid_flow0d_monodir_syspulcor_2dheart_rom 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_flow0d_monodir_syspulcor_2dheart_rom.py"]
    )
    errs["test_solid_flow0d_monodir_syspulcor_2dheart_rom 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_solid_flow0d_monodir_syspulcor_2dheart_rom.py"]
    )

    errs["test_solid_flow0d_periodicref_syspul_lvchamber 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_flow0d_periodicref_syspul_lvchamber.py"]
    )
    errs["test_solid_flow0d_periodicref_syspul_lvchamber 1 restart"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_solid_flow0d_periodicref_syspul_lvchamber.py", str(50), str(0)]
...
if category == "frsi" or category == "fluid_ale" or category == "all":
    ...
    errs["test_frsi_artseg_prefile_partitioned_schur3x3 4"] = subprocess.call(
        ["mpiexec", "-n", "4", "python3", "test_frsi_artseg_prefile_partitioned_schur3x3.py"]
    )

    errs["test_frsi_artseg_modepartitionunity 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_frsi_artseg_modepartitionunity.py"]
    )
    errs["test_frsi_artseg_modepartitionunity 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_frsi_artseg_modepartitionunity.py"]
    )
    errs["test_frsi_artseg_modepartitionunity 2 restart"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_frsi_artseg_modepartitionunity.py", str(2)]
    )

    errs["test_frsi_artseg_prefile_bgsschur4x4 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_frsi_artseg_prefile_bgsschur4x4.py"]
    )
