...
def test_main():
    ...
    IO_PARAMS = {
        ...
        "results_to_write": [
            ...
            [["fluiddisplacement", "velocity", "pressure"], ["aledisplacement", "alevelocity"]],
        ],
        "domain_ids_solid": [1],
        "domain_ids_fluid": [2],
    ...
    TIME_PARAMS_SOLID = {"maxtime": 3.0, "numstep": 150, "numstep_stop": 5, "timint": "ost", "theta_ost": 1.0}

    TIME_PARAMS_FLUID = {"maxtime": 3.0, "numstep": 150, "numstep_stop": 5, "timint": "ost", "theta_ost": 1.0}

    TIME_PARAMS_FLOW0D = {"timint": "ost", "theta_ost": 1.0, "initial_conditions": {"Q_0": 0.0, "p_0": 0.0}}
    ...
    FEM_PARAMS_SOLID = {"order_disp": 1, "order_pres": 1, "quad_degree": 5, "incompressible_2field": False}
    ...
    COUPLING_PARAMS_ALE_FLUID = {
        ...
        "fsi_governing_type": "fluid_governed",
    }  # solid_governed, fluid_governed
    ...
    MATERIALS_SOLID = {
        "MAT1": {"neohooke_dev": {"mu": 100.0}, "sussmanbathe_vol": {"kappa": 500.0}, "inertia": {"rho0": 1.0e-6}}
    }
    ...
    BC_DICT_FLUID = {
        ...
        "dirichlet": [{"id": [7], "dir": "y", "val": 0.0}, {"id": [9], "dir": "x", "val": 0.0}],
    }
    ...
    check1 = ambit_fe.resultcheck.results_check_node(
        problem.mp.pbs.u, check_node, u_corr, problem.mp.pbs.V_u, problem.mp.comm, tol=tol, nm="u", readtol=1e-4
    )
    ...
    check3 = ambit_fe.resultcheck.results_check_node(
        problem.mp.pbf.p, check_node, p_corr, problem.mp.pbf.V_p, problem.mp.comm, tol=tol, nm="p", readtol=1e-4
    )
