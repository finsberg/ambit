...
def test_main():
    ...
    TIME_PARAMS_FLOW0D = {"timint": "ost", "theta_ost": 1.0, "initial_conditions": {"Q_0": 0.0}}

    MODEL_PARAMS_FLOW0D = {"modeltype": "2elwindkessel", "parameters": {"C": 10.0, "R": 100.0, "p_ref": 0.0}}
    ...
    class time_curves:
        def tc1(self, t):
            tmax = -50.0
            return tmax * np.sin(2.0 * np.pi * t / TIME_PARAMS_SOLID["maxtime"])
