...
def test_main():
    ...
    TIME_PARAMS = {"maxtime": 1.0, "numstep": 10, "numstep_stop": 1, "timint": "genalpha", "rho_inf_genalpha": 1.0}

    FEM_PARAMS = {"order_disp": 1, "quad_degree": 1}

    MATERIALS = {
        "MAT1": {
            "exponential_dev": {"a_0": 10.0, "b_0": 120.0},
