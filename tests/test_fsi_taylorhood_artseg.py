...
def test_main():
    ...
    TIME_PARAMS_SOLID = {"maxtime": 0.1, "dt": 0.02, "timint": "ost", "theta_ost": 1.0}

    TIME_PARAMS_FLUID = {"maxtime": 0.1, "dt": 0.02, "timint": "ost", "theta_ost": 1.0}

    FEM_PARAMS_SOLID = {"order_disp": 2, "order_pres": 1, "quad_degree": 5, "incompressible_2field": True}
