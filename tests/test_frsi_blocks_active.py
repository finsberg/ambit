...
def test_main():
    ...
    ROM_PARAMS = {
        "modes_from_files": [basepath + "/input/blocks3_mode_*.txt"],
        "partitions": [
            basepath + "/input/blocks3_part-1.txt",
            basepath + "/input/blocks3_part-2.txt",
            basepath + "/input/blocks3_part-3.txt",
        ],
    ...
    SOLVER_PARAMS = {"solve_type": "direct", "tol_res": [1.0e-8, 1.0e-8, 1.0e-5], "tol_inc": [1.0e-3, 1.0e-3, 1.0e-3]}
    ...
    BC_DICT_ALE = {"dirichlet": [{"id": [5, 11, 17], "dir": "all", "val": 0.0}]}  # bottom
        ...
        "membrane": [
            {
                ...
                "params": {
                    ...
                    "active_stress": {
                        ...
                        "iota": 0.333,
                        "gamma": 0.0,
                        "weight": basepath + "/input/blocks3_part-1.txt",
                    },
                },
            },
            {
    ...
    check1 = ambit_fe.resultcheck.results_check_node(
        problem.mp.pba.d, check_node, d_corr, problem.mp.pba.V_d, problem.mp.comm, tol=tol, nm="d", readtol=1e-4
    )
