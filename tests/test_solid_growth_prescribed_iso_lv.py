...
def test_main():
    ...
    FEM_PARAMS = {"order_disp": 1, "order_pres": 1, "quad_degree": 1, "incompressible_2field": True}

    SOLVER_PARAMS_SOLID = {"solve_type": "direct", "tol_res": 1.0e-8, "tol_inc": 1.0e-8}
    ...
    MATERIALS = {
        "MAT1": {
            ...
            "growth": {"growth_dir": "isotropic", "growth_trig": "prescribed", "prescribed_curve": 1},
        }
    }
    ...
    BC_DICT = {"dirichlet": [{"id": [2], "dir": "all", "val": 0.0}]}

    # problem setup
    problem = ambit_fe.ambit_main.Ambit(
        IO_PARAMS, TIME_PARAMS_SOLID, SOLVER_PARAMS_SOLID, FEM_PARAMS, MATERIALS, BC_DICT, time_curves=time_curves()
    )
    ...
    u_corr[0] = -9.3743445617845182e00  # x
    u_corr[1] = 1.0877463102123736e01  # y
    u_corr[2] = -1.0954897338860498e02  # z

    p_corr[0] = -9.3006817518134621e00
    ...
    check2 = ambit_fe.resultcheck.results_check_node(
        problem.mp.p, check_node, p_corr, problem.mp.V_p, problem.mp.comm, tol=tol, nm="p"
    )
