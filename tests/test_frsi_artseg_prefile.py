...
def test_main():
    ...
    IO_PARAMS = {
        ...
        "results_to_write": [
            ["fluiddisplacement", "velocity", "pressure", "strainenergy_membrane", "internalpower_membrane"],
    ...
    SOLVER_PARAMS = {"solve_type": "direct", "tol_res": [1.0e-8, 1.0e-8, 1.0e-1], "tol_inc": [1.0e-1, 1.0e-3, 1.0e-1]}

    TIME_PARAMS = {"maxtime": 3.0, "numstep": 150, "numstep_stop": 3, "timint": "ost", "theta_ost": 1.0}
