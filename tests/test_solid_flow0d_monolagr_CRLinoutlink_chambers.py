...
def test_main():
    ...
    MODEL_PARAMS_FLOW0D = {
        ...
        "parameters": {"C_in": 0.001, "R_in": 1e-6, "L_in": 0.0, "C_out": 0.001, "R_out": 1e-6, "L_out": 0.0},
    }

    FEM_PARAMS = {"order_disp": 1, "order_pres": 1, "quad_degree": 5, "incompressible_2field": False}
    ...
    MATERIALS = {
        "MAT1": {
            ...
            "ogden_vol": {"kappa": 100.0 / (1.0 - 2.0 * 0.49)},
            "inertia": {"rho0": 1.0e-6},
    ...
    BC_DICT = {
        "dirichlet": [
            {"id": [1, 3], "dir": "x", "val": 0.0},
            {"id": [2, 4], "dir": "y", "val": 0.0},
    ...
    # correct 0D results
    s_corr[0] = 5.9984206989156643e00
    s_corr[1] = 5.9984750503031279e00
    s_corr[2] = 2.3053217861216080e01
    s_corr[3] = 5.9984815253587698e00
