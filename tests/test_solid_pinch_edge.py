...
def test_main():
    ...
    TIME_PARAMS = {"maxtime": 1.0, "numstep": 10, "numstep_stop": 10, "timint": "static"}

    FEM_PARAMS = {"order_disp": 1, "quad_degree": 2, "incompressible_2field": False}

    # MATERIALS         = {'MAT1' : {'neohooke_compressible' : {'mu' : 10., 'nu' : 0.1}}}
    MATERIALS = {"MAT1": {"neohooke_dev": {"mu": 10.0}, "sussmanbathe_vol": {"kappa": 500.0}}}
    ...
    BC_DICT = {
        "neumann": [{"id": [6], "dir": "xyz_ref", "curve": [0, 0, 1]}],
        "dirichlet": [{"id": [3], "dir": "all", "val": 0.0}, {"id": [1], "dir": "all", "val": 0.0, "codimension": 1}],
    }  # ,
