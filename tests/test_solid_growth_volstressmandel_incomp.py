...
def test_main():
    ...
    MATERIALS = {
        "MAT1": {
            ...
            "growth": {
                "growth_dir": "isotropic",  # isotropic, fiber, crossfiber, radial
    ...
    check_node = []
    check_node.append(np.array([1.00000000e00, 1.00000000e00, 1.00000000e00]))
    ...
    p_corr[0] = 1.6523471374159470e01
