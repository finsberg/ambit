...
def test_main():
    ...
    TIME_PARAMS = {"maxtime": 0.5, "dt": 0.1, "timint": "genalpha", "rho_inf_genalpha": 1.0}

    FEM_PARAMS = {"order_disp": 1, "quad_degree": 2, "incompressible_2field": False}

    MATERIALS = {"MAT1": {"visco_green": {"eta": 2.0}, "inertia": {"rho0": 1.0e-6}}}
    ...
    BC_DICT = {
        "neumann": [{"id": [3], "dir": "xyz_ref", "curve": [0, 0, 1]}],
