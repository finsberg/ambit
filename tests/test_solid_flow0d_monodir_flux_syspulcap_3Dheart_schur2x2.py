...
- isochoric-volumetric Neo-Hookean material, viscous Green material
...
- 2x2 block iterative method for compressible solid coupled to 0D model
"""
...
def test_main():
    ...
    TIME_PARAMS_SOLID = {"maxtime": 1.0, "numstep": 100, "numstep_stop": 1, "timint": "ost", "theta_ost": 0.5}
    ...
    FEM_PARAMS = {"order_disp": 1, "order_pres": 1, "quad_degree": 2, "incompressible_2field": False}
    ...
    MATERIALS = {
        "MAT1": {
            "neohooke_dev": {"mu": mu},
            "sussmanbathe_vol": {"kappa": mu / (1.0 - 2.0 * nu)},
            "inertia": {"rho0": 1.0e-6},
    ...
    # correct 0D results
    s_corr[0] = 1.3224831870071329e06
    s_corr[1] = 1.2929295240899021e00
    s_corr[2] = -2.2769469994097640e00
    s_corr[3] = -2.9553662917230834e-02
    s_corr[4] = 1.2035048069044571e01
    s_corr[5] = -2.2769469994097640e00
    s_corr[6] = 1.2035061730726566e01
    s_corr[7] = 7.9266377308135361e03
    s_corr[8] = 1.0920576465774184e01
    s_corr[9] = 4.8757248192029256e04
    s_corr[10] = 4.5874998138919073e04
    s_corr[11] = 3.5972406607477016e04
    s_corr[12] = 2.4558826886615869e04
    s_corr[13] = 8.1860969859040206e03
    s_corr[14] = 2.2677989748307978e00
    s_corr[15] = 8.3777994443126909e02
    s_corr[16] = 2.2702566689853443e00
    s_corr[17] = 9.5197490838433657e02
    s_corr[18] = 2.2702868290665035e00
    s_corr[19] = 7.5318898810698818e02
    s_corr[20] = 2.2701206974464680e00
    s_corr[21] = 5.0032192532496811e02
    s_corr[22] = 2.2705227084358346e00
    s_corr[23] = 1.7139469704543885e02
    s_corr[24] = 2.2541264061376798e00
    s_corr[25] = 2.0736179751521349e05
    s_corr[26] = 1.1012673782686764e05
    s_corr[27] = 2.7261590729247548e-01
    s_corr[28] = -4.3802010155644783e-01
    s_corr[29] = 1.6248916946560785e-01
    s_corr[30] = 2.4017165326029177e00
    s_corr[31] = 1.1803405214239219e04
    s_corr[32] = 2.3131909934961237e00
    s_corr[33] = 2.0065832666216767e05
    s_corr[34] = 1.6160031869924318e00
    s_corr[35] = 3.9314564313029965e04
...
def init():
    ...
    return {
        ...
        "q_ven_sys_0": 0.0,
        "q_vin_r_0": 0.0,
        "p_at_r_0": 10.0 / (5.0 * factor_kPa_mmHg),
        "q_vout_r_0": 0.0,
        "p_v_r_0": 10.0 / (5.0 * factor_kPa_mmHg),
        "p_ar_pul_0": 90.29309546 / (5.0 * factor_kPa_mmHg),
        "q_ar_pul_0": 0.0,
        "p_cap_pul_0": 90.29309546 / (5.0 * factor_kPa_mmHg),
        "q_cap_pul_0": 0.0,
