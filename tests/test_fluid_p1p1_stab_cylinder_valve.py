...
def test_main():
    ...
    FEM_PARAMS = {
        ...
        "stabilization": {"scheme": "supg_pspg", "vscale": 1e3, "dscales": [1.0, 1.0, 1.0]},
    }
    ...
    BC_DICT = {
        ...
        "neumann": [{"id": [2], "dir": "normal_ref", "curve": 1}, {"id": [4], "dir": "normal_ref", "curve": 2}],
        "robin_valve": [
            {"id": [5], "type": "dp_smooth", "beta_max": 1e3, "beta_min": 1e-3, "epsilon": 1e-6, "dp_monitor_id": 0}
