...
def test_main():
    ...
    TIME_PARAMS_SOLID = {"maxtime": 1.0, "numstep": 10, "numstep_stop": 5, "timint": "ost", "theta_ost": 0.5}

    FEM_PARAMS = {"order_disp": 2, "order_pres": 1, "quad_degree": 5, "incompressible_2field": True}

    CONSTRAINT_PARAMS = {
        "constraint_physics": [{"id": [3], "type": "volume", "prescribed_curve": 1}],
    ...
    check1 = ambit_fe.resultcheck.results_check_node(
        problem.mp.pbs.u, check_node, u_corr, problem.mp.pbs.V_u, problem.mp.comm, tol=tol, nm="u"
    )
