...
def test_main():
    ...
    SOLVER_PARAMS = {"solve_type": "direct", "tol_res": 1.0e-8, "tol_inc": 1.0e-5}

    TIME_PARAMS = {"maxtime": 1.0, "numstep": 5, "timint": "static"}

    FEM_PARAMS = {"order_disp": 1, "quad_degree": 3}

    MATERIALS = {"MAT1": {"neohooke_compressible": {"mu": 10.0, "nu": 0.3}}}
    ...
    BC_DICT = {
        "dirichlet": [{"id": [1], "dir": "all", "val": 0.0}],  # id 1: left foot
        "neumann": [{"id": [2, 3, 4], "dir": "normal_cur", "curve": 1}],
    }  # ids 2,3,4: right-inner, arch, left-inner edge
