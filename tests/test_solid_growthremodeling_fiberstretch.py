...
def test_main():
    ...
    FEM_PARAMS = {"order_disp": 1, "order_pres": 1, "quad_degree": 3, "incompressible_2field": False}

    MATERIALS = {
        "MAT1": {
            "neohooke_dev": {"mu": 10.0},
            "ogden_vol": {"kappa": 10.0 / (1.0 - 2.0 * 0.49)},
            "growth": {
                ...
                "tau_gr_rev": 10000.0,
                "gamma_gr_rev": 1.0,
                "remodeling_mat": {"neohooke_dev": {"mu": 3.0}, "ogden_vol": {"kappa": 3.0 / (1.0 - 2.0 * 0.49)}},
            },
        }
    }
    ...
    ## correct results
    u_corr[0] = 1.0812823521095760e00  # x
