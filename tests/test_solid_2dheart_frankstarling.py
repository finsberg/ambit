...
def test_main():
    ...
    SOLVER_PARAMS_SOLID = {"solve_type": "direct", "tol_res": 1.0e-8, "tol_inc": 1.0e-8, "ptc": False}
    ...
    BC_DICT = {
        ...
        "neumann": [{"id": [1], "dir": "normal_cur", "curve": 1}, {"id": [2], "dir": "normal_cur", "curve": 2}],
    ...
    ## correct results
    u_corr[0] = 4.8992618227875901e00  # x
    u_corr[1] = 2.5321717354565503e00  # y
    u_corr[2] = 0.0  # z
