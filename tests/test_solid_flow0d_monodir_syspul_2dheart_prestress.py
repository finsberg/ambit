...
def test_main():
    ...
    SOLVER_PARAMS = {"solve_type": "direct", "tol_res": [1.0e-8, 1.0e-6], "tol_inc": [1.0e-8, 1.0e-6]}
    ...
    TIME_PARAMS_FLOW0D = {"timint": "ost", "theta_ost": 0.5, "initial_conditions": init()}
    ...
    BC_DICT = {
        ...
        "neumann_prestress": [
            {"id": [1], "dir": "normal_ref", "expression": expression1},
    ...
    s_corr[2] = -1.0276098789418020e00
    s_corr[3] = 5.9853229971264454e-01
    s_corr[4] = 1.0874631089130659e01
    s_corr[5] = -7.2239293692952386e04
    s_corr[6] = 1.0874643586401094e01
    s_corr[7] = 7.1802421951344339e04
    s_corr[8] = 2.2872621917206417e00
    s_corr[9] = 8.4721438737444128e04
    ...
    s_corr[14] = 2.2121515776401313e00
    s_corr[15] = 3.5710860692899922e04
    s_corr[16] = 1.6764886672466330e00
    s_corr[17] = 8.5186113080873460e04
